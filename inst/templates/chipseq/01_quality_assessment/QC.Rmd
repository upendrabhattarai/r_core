...
ggplot2::theme_set(theme_bcbio(base_size = 13))
scale_colour_discrete <- function(...) scale_color_cb_friendly(...)
scale_fill_discrete   <- function(...) scale_fill_cb_friendly(...)

# Convenience vector for legacy code using indexed colours
colors <- unname(cb_friendly_cols(
  "teal", "hot_pink", "indigo", "amber", "coral",
  "lavender", "sky", "deep_rose", "forest", "sand",
  "light_teal", "charcoal", "steel", "blush", "deep_teal"
))
